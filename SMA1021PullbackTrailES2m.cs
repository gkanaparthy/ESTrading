...
{
    public class SMA10_21_PullbackTrail_ES2m : Strategy
    {
        // Parameters
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name = "SMA10_21_PullbackTrail_ES2m";
                Description = "2-min ES: Pullback-to-SMA entries (long & short) with PT leg and PT-gated SMA10-trailing leg.";
        ...
        private bool LongEntryConditionsMet()
        {
            ...
            bool monotonicUp = sma10[1] > sma10[2] && sma10[2] > sma10[3] && sma10[3] > sma10[4] && sma10[4] > sma10[5];
        ...
        private bool ShortEntryConditionsMet()
        {
            ...
            bool monotonicDown = sma10[1] < sma10[2] && sma10[2] < sma10[3] && sma10[3] < sma10[4] && sma10[4] < sma10[5];
            double netFall = sma10[SlopeLookbackBars + 1] - sma10[1]; // positive when falling
            double minAbs = MinSlopeRiseTicks * TickSize;
