...
{
    public class ESTrendline : Strategy
    {
        #region Models
        ...
        #region Constants
        private const string TagUp = "ESTrendline.UpTrend";
        private const string TagDn = "ESTrendline.DownTrend";
        private const string TagSafety = "ESTrendline.Safety";
        #endregion
