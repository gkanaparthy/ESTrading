...
{
    public class ATRQAVWAPTrailbkp : Strategy
    {
        ...
        // New: SMA(925) filter
        private SMA sma925;
        private const int SMA925Period = 925;
                ...
                if (Position.MarketPosition == MarketPosition.Flat && atrLevels != null)
                {
                    ...
                    else
                    {
                            ...
                            && smaNearHigh)
                        {
                            ...
                            atrAdjEntry = Math.Max(atrAdjEntry, vwapValue);
                            atrAdjEntry = Math.Max(atrAdjEntry, sma925Value);
                            ...
                            && smaNearLow)
                        {
                            ...
                            atrAdjEntry = Math.Min(atrAdjEntry, vwapValue);
                            atrAdjEntry = Math.Min(atrAdjEntry, sma925Value);
                            atrAdjEntry = Instrument.MasterInstrument.RoundToTickSize(atrAdjEntry);
